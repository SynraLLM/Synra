...
const en = {
  ...
  Export: {
    ...
    MessageFromWebLLM: "Message From SynraLLM",
    Share: "Share",
    Format: {
      Title: "Export Format",
  ...
  ServiceWorker: {
    Error:
      "The SynraLLM worker has lost connection. Please close all tabs of SynraLLM Chat and try opening SynraLLM Chat again.",
  },
  MlcLLMConnect: {
